...
<body>
    ...
    <section>
        <video autoplay muted loop id="bg-video" src="7videos/videoFondo.mp4"></video>
    </section>
    ...
    <section>
        ...
        <div class="row container">
            ...
            <div class="col-12 d-flex justify-content-center align-items-center">
                ...
                <form class="text-white pt-5 mt-5 bt-1" action="/guardar_comentario" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <a href="listado_comentario">Cancelar</a>
                </form>

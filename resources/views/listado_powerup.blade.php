    ...
    <section>
        ...
        <div class="row container ">
            ...
            <div class="col-12 text-white pt-5 text-center">
                ...
                <h1 class="pt-5"><a href="formulario_powerup">Agregar powerup</a></h1>
                <h1 class="py-5 pixelify-sans">Listado powerups</h1>
                ...
                <div class="col-12 px-5 mx-5">
                    ...
                    <table class="table table-dark table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $powerup['id'] }}</td>
                                <td>{{ $powerup['nombre'] }}</td>
                                <td>{{ $powerup['descripcion'] }}</td>
                                <td><img class="w-50" src="/imagenes_powerups/{{ $powerup['imagen'] }}"></td>
                                <td>
                                    <a href="formulario_powerup/{{$powerup['id']}}">Editar</a>
                                    <a href="eliminar_powerup/{{$powerup['id']}}">Eliminar</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>

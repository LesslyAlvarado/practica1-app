    ...
    <section>
        ...
        <div class="row container">
            ...
            <div class="col-12 d-flex justify-content-center align-items-center">
                ...
                <form class="text-white pt-5 mt-5 bt-1" action="/guardar_plataforma" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input class="form-control" type="hidden" name="id" value="{{empty($id) ? '' : $id}}">
                    <label>Nombre:</label>
                    <br>
                    <input class="form-control" type="text" name="nombre" value="{{empty($nombre) ? '' : $nombre}}">
                    <br>
                    <label>Descripcion:</label>
                    <br>
                    <input class="form-control" type="text" name="descripcion" value="{{empty($descripcion) ? '' : $descripcion}}">
                    <br>
                    <label>Imagen:</label>
                    <br>
                    <input class="form-control" type="file" name="imagen" value="{{empty($imagen) ? '' : $imagen}}">
                    <br>
                    <button class="btn btn-light" type="submit">{{ empty($id) ? 'Agregar' : 'Modificar'}}</button>
                    <a href="listado_plataforma">Cancelar</a>
                </form>
